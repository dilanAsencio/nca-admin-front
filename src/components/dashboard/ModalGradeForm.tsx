                ...
                <InputComponent
                  ...
                  <Controller
                    ...
                    <DropdownComponent
                        ...
                        options={optionsLevels && optionsLevels.length > 0 ? optionsLevels : []}
                        onChange={(value) => {selectedLevel(value); field.onChange(value);}}
                        value={field.value}
                        required
                        error={errorsGrade.academicLevelId && errorsGrade.academicLevelId.message}
                        />
                    )}
                  />
                <InputComponent
                  ...
                  className="text-right"
                  name="valor"
                  register={registerGrade("valor",{
                    onChange: (e) => {
                      const value = e.target.value;
                      // setValueGrade("valor", parseInt(handleFormatCurrency(value)));
                    }
                  })}
                  required
                  error={errorsGrade.valor && errorsGrade.valor.message}
                  />
            </div>
