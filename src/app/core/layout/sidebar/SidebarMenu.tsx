...
const SidebarMenu: React.FC = () => {
  ...
  return (
    <aside
      className={`sidebar ${hoverSidebar ? "hv-active w-[15rem] pl-[1rem]" : ""} fixed top-0 left-0 bottom-0 h-svh transition-all duration-400 ease-in-out 
    ...
    >
      <div className="flex flex-col items-center gap-[3.5rem] w-[100%]">
        <div className="sidebar-header">
          <img
            src={`/assets/img/${isOpenSidebar || hoverSidebar ? "logo-nc-aca" : "logo-nc-aca-light"}.svg`}
