...
import { slideVariants } from "../core/constants/payments-constants";
...
const ModalCurriculum: React.FC<{
  ...
  const columnsAsistence = [
    { key: "labels", nameField: "", width: "w-[66%]" },
    { key: "info", nameField: "" },
  ];
  ...
  return (
    <AnimatePresence>
        ...
        >
          ...
          <div className="fixed bottom-0 left-[64%] py-[19.2px] px-[3px] w-[0.5rem] h-full flex flex-col gap-[1rem]">
